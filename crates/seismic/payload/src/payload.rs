...
use seismic_alloy_consensus::{encode_holocene_extra_data, EIP1559ParamError};
use alloy_rpc_types_engine::{
    ExecutionPayloadEnvelopeV3, ExecutionPayloadEnvelopeV4, OpExecutionPayloadV4,
};
...
pub use alloy_rpc_types_engine::PayloadAttributes;
...
impl<SeismicTransactionSigned> From<EthPayloadBuilderAttributes>
    for OpPayloadBuilderAttributes<SeismicTransactionSigned>
{
...
#[derive(Debug, Clone)]
pub struct OpBuiltPayload<N: NodePrimitives = SeismicPrimitives> {
...
impl<T, N> From<OpBuiltPayload<N>> for ExecutionPayloadEnvelopeV3
where
    T: SignedTransaction,
    N: NodePrimitives<Block = Block<T>>,
{
...
impl<T, N> From<OpBuiltPayload<N>> for ExecutionPayloadEnvelopeV4
where
    T: SignedTransaction,
    N: NodePrimitives<Block = Block<T>>,
{
...
mod tests {
    ...
    fn test_get_extra_data_post_holocene() {
        let attributes: OpPayloadBuilderAttributes<SeismicTransactionSigned> =
