...
const FLAGGED_STORAGE_SET_PUBLIC: &str = "31845f7d";
const FLAGGED_STORAGE_SET_PRIVATE: &str = "420f38f8";
const FLAGGED_STORAGE_READ_PUBLIC_SLOAD: &str = "717d5de3";
const FLAGGED_STORAGE_READ_PRIVATE_SLOAD: &str = "ef561792";
const FLAGGED_STORAGE_READ_PRIVATE_SLOAD_RAW: &str = "4e0d898c";
const FLAGGED_STORAGE_READ_PRIVATE_CLOAD: &str = "9ad95ef8";
const FLAGGED_STORAGE_READ_PUBLIC_CLOAD: &str = "94193f11";
