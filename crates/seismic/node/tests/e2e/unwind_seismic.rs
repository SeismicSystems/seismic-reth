...
fn get_deploy_bytecode() -> Bytes {
    Bytes::from_static(&hex!(""))
}
...
async fn test_unwind_seismic_transactions() {
    ...
    for i in 1..=5 {
        ...
        let pending_tx = provider.send_transaction(set_num_tx).await.unwrap();
        let tx_hash = pending_tx.tx_hash();
        thread::sleep(Duration::from_secs(WAIT_FOR_RECEIPT_SECONDS));

        let receipt = provider.get_transaction_receipt(*tx_hash).await.unwrap().unwrap();
        assert!(receipt.status(), "Transaction {} failed", i);
