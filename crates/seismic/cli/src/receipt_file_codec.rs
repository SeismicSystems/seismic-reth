...
impl TryFrom<OpGethReceipt> for SeismicReceipt {
    type Error = FileClientError;
    ...
    fn try_from(exported_receipt: OpGethReceipt) -> Result<Self, Self::Error> {
        ...
        let tx_type = SeismicTxType::try_from(tx_type.to_be_bytes()[0])
        ...
        match tx_type {
            SeismicTxType::Legacy => Ok(Self::Legacy(receipt)),
            SeismicTxType::Eip2930 => Ok(Self::Eip2930(receipt)),
            SeismicTxType::Eip1559 => Ok(Self::Eip1559(receipt)),
            SeismicTxType::Eip7702 => Ok(Self::Eip7702(receipt)),
            SeismicTxType::Seismic => Ok(Self::Seismic(receipt)),
        }
    }
}
...
pub(crate) mod test {
    ...
    pub(crate) fn receipt_block_1() -> ReceiptWithBlockNumber<SeismicReceipt> {
        let log_1 = Log {
    ...
    pub(crate) fn receipt_block_2() -> ReceiptWithBlockNumber<SeismicReceipt> {
        let log_1 = Log {
            address: address!("0x8ce8c13d816fe6daf12d6fd9e4952e1fc88850af"),
            data: LogData::new(
                vec![
    ...
    pub(crate) fn receipt_block_3() -> ReceiptWithBlockNumber<SeismicReceipt> {
        let log_1 = Log {
            address: address!("0x8ce8c13d816fe6daf12d6fd9e4952e1fc88850af"),
            data: LogData::new(
                vec![
