...
mod tests {
    ...
    fn from_bundle_state_with_rayon() {
        ...
        let bundle_state = BundleState::builder(2..=2)
            ...
            .state_storage(address1, HashMap::from([(slot1, (FlaggedStorage::ZERO, U256::from(10).into()))]))
            .state_storage(address2, HashMap::from([(slot2, (FlaggedStorage::ZERO, U256::from(20).into()))]))
            .build();
