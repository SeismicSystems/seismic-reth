 ...
 *   3. Reset and start Summit testnet:
 *        cd ~/Desktop/Seismic/summit/testnet && ./reset.sh && cd ..
 *        cargo run --release --bin testnet
 *   4. Node RPC available at http://localhost:8545
 *
 * Usage:
...
const OUTPUT_DIR = "crates/seismic/node/tests/e2e/testdata/rpc-compat";
...
async function main() {
  ...
  console.log("  cargo nextest run -p reth-seismic-node --test e2e -E 'test(rpc_compat)'");
}
